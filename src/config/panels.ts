...
const FULL_PANELS: Record<string, PanelConfig> = {
  map: { name: 'Iran War Theater Map', enabled: true, priority: 1 },
  'live-news': { name: 'War Live News', enabled: true, priority: 1 },
  insights: { name: 'AI War Insights', enabled: true, priority: 1 },
  'strategic-posture': { name: 'Theater Strategic Posture', enabled: true, priority: 1 },
  'strategic-risk': { name: 'Escalation Risk', enabled: true, priority: 1 },
  intel: { name: 'Defense & Intel Feed', enabled: true, priority: 1 },
  'gdelt-intel': { name: 'Live War Intelligence', enabled: true, priority: 1 },
  middleeast: { name: 'Middle East Frontlines', enabled: true, priority: 1 },
  politics: { name: 'Iran War Headlines', enabled: true, priority: 1 },
  energy: { name: 'Oil & Energy Impact', enabled: true, priority: 1 },
  gov: { name: 'US/Israel Government', enabled: true, priority: 1 },
  thinktanks: { name: 'Defense Think Tanks', enabled: true, priority: 1 },
  polymarket: { name: 'War Predictions', enabled: true, priority: 1 },
  commodities: { name: 'Oil & Commodities', enabled: true, priority: 1 },
  markets: { name: 'War Market Impact', enabled: true, priority: 1 },
  economic: { name: 'Economic Fallout', enabled: true, priority: 1 },
  cii: { name: 'Country Instability', enabled: true, priority: 1 },
  cascade: { name: 'Infrastructure Impact', enabled: true, priority: 1 },
  'satellite-fires': { name: 'Strike Fires', enabled: true, priority: 1 },
  ...
  finance: { name: 'Financial Impact', enabled: true, priority: 2 },
  'macro-signals': { name: 'War Market Radar', enabled: true, priority: 2 },
  'population-exposure': { name: 'Population at Risk', enabled: true, priority: 2 },
};
