...
export const INTEL_HOTSPOTS: Hotspot[] = [
  ...
  },
  {
    id: 'tehran',
    name: 'Tehran',
    subtext: 'ACTIVE WAR ZONE',
    lat: 35.7,
    lon: 51.4,
    location: 'Iran',
    keywords: ['iran', 'tehran', 'irgc', 'khamenei', 'persian', 'iranian', 'operation shield of judah', 'operation epic fury', 'mojtaba khamenei'],
    agencies: ['IRGC', 'Quds Force', 'MOIS', 'Iranian Air Defense'],
    description: 'Under active US-Israeli bombardment since Feb 28, 2026. Supreme Leader killed. Nuclear facilities struck. New leader Mojtaba Khamenei. IRGC launching retaliatory ballistic missiles at Israel.',
    status: 'Active Conflict',
    escalationScore: 5,
    escalationTrend: 'escalating',
    escalationIndicators: ['Supreme Leader killed', 'Nuclear sites struck', 'Retaliatory missile barrages', 'Strait of Hormuz closed', 'New hardliner supreme leader'],
    history: {
      lastMajorEvent: 'Operation Shield of Judah begins',
      lastMajorEventDate: '2026-02-28',
      precedentCount: 5,
      precedentDescription: 'Revolution 1979, Iran-Iraq War, JCPOA negotiations, Soleimani assassination, June 2025 Iran strikes',
      cyclicalRisk: 'Active war - continuous operations',
    },
    whyItMatters: 'Active war with US & Israel; nuclear program being destroyed; Strait of Hormuz closed disrupting 20% of global oil; proxy network activated; global recession risk',
  },
  {
    id: 'telaviv',
    name: 'Tel Aviv',
    ...
    lon: 34.8,
    location: 'Israel',
    keywords: ['israel', 'idf', 'mossad', 'gaza', 'netanyahu', 'israeli', 'hamas', 'hezbollah', 'iron dome', 'arrow'],
    agencies: ['IDF', 'Mossad', 'Shin Bet', 'Israeli Air Force'],
    description: 'Leading joint Operation Shield of Judah against Iran. Under Iranian ballistic missile attack. Multi-front war: Iran, Hezbollah, Gaza. National state of emergency declared. Air defense interceptors costing $2.5M each. 200+ Iranian missiles intercepted.',
    status: 'Active Conflict',
    escalationScore: 5,
    escalationTrend: 'escalating',
    escalationIndicators: ['Joint war with US against Iran', 'Iranian missile barrages', 'Hezbollah rocket attacks', 'National emergency declared', '4,000+ munitions dropped on Iran'],
    history: {
      lastMajorEvent: 'Operation Shield of Judah launched',
      lastMajorEventDate: '2026-02-28',
      precedentCount: 6,
      precedentDescription: '1948 War, 1967 Six-Day War, 1973 Yom Kippur, Lebanon 2006, Gaza wars, June 2025 Iran campaign',
      cyclicalRisk: 'Active war - continuous operations',
    },
    whyItMatters: 'Leading joint US-Israeli war against Iran; interceptor stockpile depleting; multi-front conflict; nuclear-armed state at war; global oil markets disrupted',
  },
  {
    id: 'pyongyang',
    name: 'Pyongyang',
  ...
  },
  {
    ...
    lon: 51.5,
    location: 'Qatar',
    keywords: ['qatar', 'doha', 'qatari', 'al udeid', 'caoc', 'centcom', 'combined air operations'],
    agencies: ['CENTCOM', 'CAOC', 'USAF', 'Qatari State Security'],
    description: 'Al Udeid Air Base hosts the Combined Air Operations Center coordinating US-Israeli strikes against Iran. Critical war command node for Operation Epic Fury.',
    status: 'Active Operations',
    escalationScore: 4,
    escalationTrend: 'escalating',
    escalationIndicators: ['CAOC directing Iran strikes', 'CENTCOM forward HQ', 'Potential Iranian missile target', 'Critical C2 node'],
  },
  {
    id: 'ankara',
    name: 'Ankara',
  ...
  },
  {
    id: 'sanaa',
    name: "Sana'a",
    subtext: 'Houthi/Iran Proxy Front',
    lat: 15.4,
    lon: 44.2,
    keywords: ['yemen', 'houthi', 'sanaa', 'yemeni', 'red sea', 'bab el-mandeb'],
    agencies: ['Houthi Forces', 'US Navy', 'IRGC Quds Force'],
    description: 'Key Iran proxy front. Houthis escalating Red Sea attacks as part of Iran war. Threatening US Navy. Part of Iran\'s Axis of Resistance response to Operation Shield of Judah.',
    status: 'Active Conflict',
    escalationScore: 5,
    escalationTrend: 'escalating',
    escalationIndicators: ['Escalated attacks since Iran war', 'Threatening US naval assets', 'Iran weapon resupply', 'Red Sea shipping paralyzed', 'Bab el-Mandeb chokepoint'],
    history: {
      lastMajorEvent: 'Iran war escalation',
      lastMajorEventDate: '2026-02-28',
      precedentCount: 4,
      precedentDescription: 'Civil war since 2014, Saudi intervention 2015, US strikes 2024, Iran war 2026',
      cyclicalRisk: 'Active war - continuous operations',
    },
    whyItMatters: 'Disrupting 12% of global trade; threatening US Navy; Iran proxy demonstration; Bab el-Mandeb chokepoint; global shipping insurance spiking',
  },
  {
    id: 'abudhabi',
    name: 'Abu Dhabi',
...
export const STRATEGIC_WATERWAYS: StrategicWaterway[] = [
  ...
  { id: 'hormuz_strait', name: 'STRAIT OF HORMUZ', lat: 26.5, lon: 56.5, description: 'EFFECTIVELY CLOSED - Iran blocking passage, 20% of global oil transit, tanker insurance cancelled' },
  { id: 'bosphorus', name: 'BOSPHORUS STRAIT', lat: 41.1, lon: 29.0, description: 'Black Sea access, Turkey control' },
  { id: 'suez', name: 'SUEZ CANAL', lat: 30.5, lon: 32.3, description: 'Transit reduced due to Red Sea Houthi attacks and Iran war disruption' },
  ...
  { id: 'bab_el_mandeb', name: 'BAB EL-MANDEB', lat: 12.5, lon: 43.3, description: 'Under Houthi attack - Part of Iran war, 12% of global trade disrupted' },
...
export const CONFLICT_ZONES: ConflictZone[] = [
  ...
  {
    id: 'iran_war',
    name: 'Iran War - Operation Shield of Judah',
    coords: [[44, 38], [62, 38], [62, 25], [44, 25]],
    center: [52, 32],
    intensity: 'high',
    parties: ['USA', 'Israel', 'Iran', 'IRGC', 'Hezbollah', 'Houthis'],
    casualties: 'Unknown (ongoing)',
    displaced: '500K+ (est.)',
    keywords: ['iran', 'tehran', 'irgc', 'operation shield of judah', 'operation epic fury', 'natanz', 'fordow', 'isfahan', 'iranian', 'khamenei'],
    startDate: 'Feb 28, 2026',
    location: 'Iran (Tehran, Isfahan, Kermanshah, Tabriz, Karaj)',
    description: 'Joint US-Israeli military campaign against Iran. Operation Shield of Judah (Israel) / Operation Epic Fury (US). Targeting nuclear facilities, missile launchers, military infrastructure, and IRGC leadership. Iran retaliating with ballistic missiles against Israel. Strait of Hormuz effectively closed to shipping.',
    keyDevelopments: ['Supreme Leader killed Feb 28', 'Nuclear sites struck', '300+ missile launchers destroyed', '10/17 airbases hit', 'Mojtaba Khamenei named new supreme leader', '200+ Iranian ballistic missiles fired at Israel', 'Strait of Hormuz closed', 'Oil prices surging past $90/barrel'],
  },
  {
    id: 'gaza',
    name: 'Gaza Conflict',
    ...
    description: 'Ongoing Israeli military operations in Gaza. Now a secondary front as Iran war dominates Israeli military attention.',
    keyDevelopments: ['Rafah operation', 'Humanitarian crisis', 'Regional escalation to Iran war'],
  },
  {
    id: 'sudan',
  ...
  {
    id: 'yemen_redsea',
    name: 'Houthi Red Sea / Iran War Front',
    coords: [[42, 12], [42, 16], [44, 16], [45, 13], [44, 12]],
    center: [43, 14],
    intensity: 'high',
    parties: ['Houthis', 'US Navy', 'Iran (supplier)', 'Yemen Govt'],
    casualties: 'Unknown (Maritime + Yemen)',
    displaced: '4.5M+ (Yemen)',
    keywords: ['houthi', 'red sea', 'yemen', 'missile', 'drone', 'ship', 'bab el-mandeb'],
    startDate: 'Nov 19, 2023',
    location: 'Red Sea & Gulf of Aden, Yemen',
    description: 'Houthi forces escalated Red Sea attacks as part of Iran\'s Axis of Resistance response. Threatening US naval assets. Disrupting 12% of global trade. Key Iran proxy front in the wider war.',
    keyDevelopments: ['Escalated attacks since Iran war began', 'Threatening US Navy', 'Trade disruption intensifying', 'Iran weapon supplies continuing'],
  },
  {
    id: 'south_lebanon',
    name: 'Lebanon-Hezbollah Front',
    coords: [[35.1, 33.0], [35.1, 33.8], [36.5, 33.8], [36.5, 33.0]],
    center: [35.4, 33.4],
    intensity: 'high',
    parties: ['Israel (IDF)', 'Hezbollah', 'UNIFIL'],
    casualties: '1,000+ killed',
    displaced: '300k+ displaced',
    keywords: ['hezbollah', 'lebanon', 'israel', 'border', 'rocket', 'airstrike', 'nasrallah'],
    startDate: 'Oct 8, 2023',
    location: 'Lebanon / Northern Israel',
    description: 'Hezbollah has fully entered the Iran war, launching rockets and drones against Israel. 150,000+ rockets estimated. $50M monthly budget from Iran for rearming. Major escalation since Feb 28.',
    keyDevelopments: ['Full entry into Iran war', 'Precision-guided rocket barrages', 'IDF northern operations', 'Rearming with $50M/month from Iran'],
  },
];
