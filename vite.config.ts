...
const VARIANT_META: Record<string, {
  ...
  full: {
    title: 'Iran War Monitor - Israel-USA-Iran Conflict Dashboard',
    description: 'Real-time intelligence dashboard tracking the Israel-USA-Iran war. Operation Shield of Judah / Epic Fury. Live news, military ops, oil markets, conflict zones, Strait of Hormuz, and humanitarian impact.',
    keywords: 'Iran war, Israel Iran conflict, Operation Shield of Judah, Operation Epic Fury, Middle East war, Iran nuclear, Strait of Hormuz, oil prices, IRGC, IDF, CENTCOM, Hezbollah, Houthi, war dashboard, military operations',
    url: 'https://worldmonitor.app/',
    siteName: 'Iran War Monitor',
    shortName: 'IranWarMonitor',
    subject: 'Israel-USA-Iran War Intelligence and Situation Awareness',
    classification: 'War Dashboard, Conflict Intelligence, OSINT Tool',
    ...
    features: [
      ...
      'Defense think tank analysis',
      'Proxy front monitoring',
    ],
  },
  tech: {
